...
class Hello2Fragment : Fragment() {
    ...
    private fun setUpButtonNext(){
        binding.buttonContinue.setOnClickListener {
                ...
                Toast.makeText(requireContext(), "Please, choose currency", Toast.LENGTH_SHORT).show()
        }
    }

    private fun setupCurrency(){
        binding.chipCurrencyGroup.setOnCheckedStateChangeListener { group, checkedIds ->
            if (checkedIds.isEmpty()){
                ...
                binding.buttonContinue.setOnClickListener {
                    ...
                    findNavController().navigate(R.id.action_hello2Fragment_to_navigation_dashboard,
                        null,
                        NavOptions.Builder()
