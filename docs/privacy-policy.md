...
Если в приложении появятся функции, которым нужна отправка данных (например, ИИ-подсказки в Premium), они будут включаться только с вашего явного согласия, а эта политика будет обновлена до их запуска.
